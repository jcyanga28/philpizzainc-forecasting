...
<div id="new_btn_content">
	...
	&nbsp;
	<a href="<?php echo base_url('daily_forecasting/add'); ?>"><button type="button" id="button_design" class="btn btn-success"><span class="glyphicon glyphicon-plus"> </span> New Daily Forecast </button></a>
...
<h5 style="margin-left: -10px; margin-top: -10px;" id="page_title"><b>History Forecast Date-range (for viewing and updating).</b></h5>

<form action="<?php echo base_url('daily_forecasting/display'); ?>" method="GET" style="margin-top: 25px;" id="daily_forecasting_daterange_form">
...
<h5 style="margin-left: 67px;" id="page_title"><b>History Forecast (for viewing and updating).</b></h5>

<div style="margin:0 auto;width:85%;margin-top:-25px;">
...
<form action="<?php echo base_url('daily_forecasting/save_remarks?daterange_start=') . $daterange_start . '&daterange_end=' . $daterange_end ; ?>" method="POST" id="modal_form_remarks">
