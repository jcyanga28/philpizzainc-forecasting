...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('daily_forecasting/wednesday_forecast?start='.$startdate.'&end='.$end_date.'&version='.$version); ?>">Wednesday</a></li>
	...
	<div style="width:95%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('daily_forecasting/u_adjfo2?startdate=') . $startdate . '&end_date=' . $end_date . '&version=' . $version; ?>" method="POST" id="df_wednesday">	
			
			<div style="border-radius: 5px; box-shadow: 0px 0px 2px 1px #888888; margin-top: 60px;">

				<input type="hidden" name="daytwo_date" id="daytwo_date" value="<?php echo $seconddate_display; ?>" />	
                ...
                <thead>
					...
					<tr>
						...
						<td style="border-right:solid 2px #eee;text-align:center;"><b style="font-size: 11px;color:#666;">
							<?php 
								$split_fdate = explode("-",$seconddate_display);
...
$.ajax({
type: "POST",
url:  domain+'/daily_forecasting/u_update2',
data:  {forecasted_amount: $(this).val(), daytwo_date: $('#daytwo_date').val()},
dataType: "json",
