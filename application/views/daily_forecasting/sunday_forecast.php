...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('daily_forecasting/sunday_forecast?start='.$startdate.'&end='.$end_date.'&version='.$version); ?>">Sunday</a></li>
	...
	<div style="width:95%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('daily_forecasting/u_adjfo6?startdate=') . $startdate . '&end_date=' . $end_date . '&version=' . $version; ?>" method="POST" id="df_sunday">
			
			<div style="border-radius: 5px; box-shadow: 0px 0px 2px 1px #888888; margin-top: 60px;">

				<input type="hidden" name="daysix_date" id="daysix_date" value="<?php echo $sixthdate_display; ?>" />	
                ...
                <thead>
					...
					<tr>
						...
						<td style="border-right:solid 2px #eee;text-align:center;"><b style="font-size: 11px;color:#666;">
							<?php 
								$split_fdate = explode("-",$sixthdate_display);
...
$.ajax({
type: "POST",
url:  domain+'/daily_forecasting/u_update6',
data:  {forecasted_amount: $(this).val(), daysix_date: $('#daysix_date').val()},
dataType: "json",
