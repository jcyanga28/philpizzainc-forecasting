...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('daily_forecasting/friday_forecast?start='.$startdate.'&end='.$end_date.'&version='.$version); ?>">Friday</a></li>
	...
	<div style="width:95%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('daily_forecasting/u_adjfo4?startdate=') . $startdate . '&end_date=' . $end_date . '&version=' . $version; ?>" method="POST" id="df_friday">	
			
			<div style="border-radius: 5px; box-shadow: 0px 0px 2px 1px #888888; margin-top: 60px;">

				<input type="hidden" name="dayfour_date" id="dayfour_date" value="<?php echo $fourthdate_display; ?>" />	
                ...
                <thead>
					...
					<tr>
						...
						<td style="border-right:solid 2px #eee;text-align:center;"><b style="font-size: 11px;color:#666;">
							<?php 
								$split_fdate = explode("-",$fourthdate_display);
...
$.ajax({
type: "POST",
url:  domain+'/daily_forecasting/u_update4',
data:  {forecasted_amount: $(this).val(), dayfour_date: $('#dayfour_date').val()},
dataType: "json",
