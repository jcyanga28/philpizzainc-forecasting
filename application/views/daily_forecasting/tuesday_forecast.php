...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('daily_forecasting/tuesday_forecast?start='.$startdate.'&end='.$end_date.'&version='.$version); ?>">Tuesday</a></li>
	...
	<div style="width:95%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('daily_forecasting/u_adjfo1?startdate=') . $startdate . '&end_date=' . $end_date . '&version=' . $version; ?>" method="POST" id="df_tuesday">
                ...
                <thead>
					...
					<tr>
						...
						<td style="border-right:solid 2px #eee;text-align:center;"><b style="font-size: 11px;color:#666;">
							<?php 
								$split_fdate = explode("-",$firstdate_display);
...
$.ajax({
type: "POST",
url:  domain+'/daily_forecasting/u_update1',
