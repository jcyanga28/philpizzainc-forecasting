...
<form action="" method="POST" id="myform" style="margin-left: 20px;" >
	...
	&nbsp;<input type="text" name="role" id="inputs" value="<?php set_value('role');?>" placeholder=" Type here. " >
	
   <div style="margin-top: 20px;width:442px;text-align:right;">		
	<input type="submit" value="Add Role" id="button_design" class="btn btn-info">
