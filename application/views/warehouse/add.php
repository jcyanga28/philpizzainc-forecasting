...
<form action="" method="POST" id="myform" style="margin-left: 20px;" >
	...
	&nbsp;<input type="text" name="warehouse" id="inputs" value="<?php set_value('warehouse');?>" placeholder=" Type here. " >
	
   <div style="margin-top: 20px;width:485px;text-align:right;">		
	<input type="submit" value="Add Warehouse" id="button_design" class="btn btn-info">
