...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('monthly_forecasting/third_month_forecast?start_month='.$monthstart.'&end_month='.$monthend.'&version='.$version); ?>">3rd Month</a></li>
	...
	<div style="width:90%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('monthly_forecasting/u_adjfo3?monthstart=') . $monthstart . '&monthend=' . $monthend . '&version=' . $version; ?>" method="POST" id="mf_tmonth">
			
			<div style="border-radius: 5px; box-shadow: 0px 0px 2px 1px #888888; margin-top: 60px;">

			<input type="hidden" name="tmonth_from" id="tmonth_from" value="<?php echo $tmonth_from; ?>" />
			<input type="hidden" name="tmonth_end" id="tmonth_end" value="<?php echo $tmonth_end; ?>" />
...
$.ajax({
type: "POST",
url:  domain+'/monthly_forecasting/u_update3',
data:  {forecasted_amount: $(this).val(), date_from: $('#tmonth_from').val(), date_to: $('#tmonth_end').val()},
dataType: "json",
