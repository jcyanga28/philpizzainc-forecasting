...
?>
	...
	<div id="new_btn_content">
		...
		<?php echo nbs(2); ?>
		<a href="<?php echo base_url('monthly_forecasting/save_forecast?monthstart=').$monthstart.'&monthend='.$monthend; ?>" style="font-family: Segoe UI Semibold;"><button type="button" id="button_design" 
	...
	<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
		...
		<li class="active"><a href="<?php echo base_url('monthly_forecasting/summary_forecast?monthstart='.$monthstart.'&monthend='.$monthend.'&ref_monthstart='.$ref_monthstart.'&ref_month_end='.$ref_month_end.'&type='.$type); ?>">Summary Forecast</a></li>
		<?php if($role_id == 2): ?>
