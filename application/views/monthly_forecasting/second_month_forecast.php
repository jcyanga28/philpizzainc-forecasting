...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('monthly_forecasting/second_month_forecast?start_month='.$monthstart.'&end_month='.$monthend.'&version='.$version); ?>">2nd Month</a></li>
	...
	<div style="width:90%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('monthly_forecasting/u_adjfo2?monthstart=') . $monthstart . '&monthend=' . $monthend . '&version=' . $version; ?>" method="POST" id="mf_smonth">
			
			<div style="border-radius: 5px; box-shadow: 0px 0px 2px 1px #888888; margin-top: 60px;">

				<input type="hidden" name="smonth_from" id="smonth_from" value="<?php echo $smonth_from; ?>" />
				<input type="hidden" name="smonth_end" id="smonth_end" value="<?php echo $smonth_end; ?>" />	
...
$.ajax({
type: "POST",
url:  domain+'/monthly_forecasting/u_update2',
data:  {forecasted_amount: $(this).val(), date_from: $('#smonth_from').val(), date_to: $('#smonth_end').val()},
dataType: "json",
