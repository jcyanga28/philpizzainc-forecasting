...
<div style="margin: 0 auto; width: 90%;margin-top: 10px;">
	...
	<li class="active"><a href="<?php echo base_url('monthly_forecasting/first_month?monthstart='.$monthstart.'&monthend='.$monthend.'&ref_monthstart='.$ref_monthstart.'&ref_month_end='.$ref_month_end.'&type='.$type); ?>">1st Month</a></li>
	...
	<div style="width:90%;margin: 0 auto;">
		...
		<form action="<?php echo base_url('monthly_forecasting/adjfo1?monthstart=') . $monthstart . '&monthend=' . $monthend.'&ref_monthstart='.$ref_monthstart.'&ref_month_end='.$ref_month_end.'&type='.$type; ?>" method="POST" id="mf_fmonth">
			<div style="border-radius: 5px; box-shadow: 0px 0px 2px 1px #888888; margin-top: 60px;">

				<input type="hidden" name="fmonth_from" id="fmonth_from" value="<?php echo $ffmonth_from; ?>" />
				<input type="hidden" name="fmonth_end" id="fmonth_end" value="<?php echo $ffmonth_end; ?>" />	
...
$.ajax({
type: "POST",
url:  domain+'/monthly_forecasting/update1',
data:  {forecasted_amount: $(this).val(), date_from: $('#fmonth_from').val(), date_to: $('#fmonth_end').val(), ref_date_from: $('#ref_month_start').val(), ref_date_to: $('#ref_month_to').val()},
dataType: "json",
