...
<br/>
<h4 id="page_title">Get Monthly Forecast(<?php echo $plant_name; ?>)</h4>
...
<h4 style="margin-left: -2px;" id="page_title">List of all Forecast</h4>
<br/>
	...
	<div style="border-top:3px solid #eee; margin-top: 10px;">
			<table class="table table-hover">
				<thead>
					<th style="text-align:center;font-family:Georgia;color:#666666;"><span class="glyphicon glyphicon-list-alt"></span> Location</th>
				...
				<?php foreach($result as $row): ?>
					...
					<td><a href="<?php echo base_url('monthly_forecasting/viewing?start_month=') . $row['fdate_from'] . '&end_month=' . $row['tdate_from'] . '&version=' . $row['versions']; ?>">View</a> 
						| <a href="#" ><button type="button" value="<?php echo $row['fdate_from'] . '|' . $row['tdate_from'] . '|' . $row['versions']; ?>" class="remarks_modal" style="border:0;background:transparent;">Download</button></a>
					</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
