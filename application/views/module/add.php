...
<form action="" method="POST" id="myform" style="margin-left: 20px;" >
	...
	&nbsp;<input type="text" name="module" id="inputs" value="<?php set_value('module');?>" placeholder=" Type here. " >
	
   <div style="margin-top: 20px;width:462px;text-align:right;">		
	<input type="submit" value="Add Module" id="button_design" class="btn btn-info">
