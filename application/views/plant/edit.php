...
<form action="" method="POST" id="myform" style="margin-left: 20px;" >
	...
	&nbsp;<input type="text" name="plant" id="inputs" value="<?php echo $plant['plant'];?>" placeholder=" Type here. " >
	
   <div style="margin-top: 20px;width:445px;text-align:right;">		
	<input type="submit" value="Edit Plant" id="button_design" class="btn btn-info">
